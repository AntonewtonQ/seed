...
export type PlatformInboxNotification = {
  id: string
  title: string
  body: string
...
type PlatformHeaderInboxProps = {
  messages: PlatformInboxMessage[]
  messagesHref: string
  notifications: PlatformInboxNotification[]
...
export function PlatformHeaderInbox({
  messages,
  messagesHref,
  notifications,
  notificationsHref,
}: PlatformHeaderInboxProps) {
